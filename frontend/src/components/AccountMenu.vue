<template>
    <details class="cu-disclosure cu-account cu-account--sidebar" data-popover="account">
      <summary aria-label="账号菜单" aria-expanded="false"><span class="cu-avatar">{{ displayInitial }}</span><span class="cu-account-copy"><span class="cu-account-caption">账号中心</span><strong class="cu-account-name">{{ auth.displayName }}</strong><small class="cu-account-role">个人书签</small></span><AppIcon class="cu-chevron" name="up" /></summary>
